...
#[link(name = "student_interfaces__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__student_interfaces__action__Progress() -> *const std::ffi::c_void;
}

// Corresponds to student_interfaces__action__Progress
#[allow(missing_docs, non_camel_case_types)]
pub struct Progress;
...
impl rosidl_runtime_rs::Action for Progress {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__student_interfaces__action__Progress() }
  }
