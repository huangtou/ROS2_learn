...
class Addints_Event(metaclass=Metaclass_Addints_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<student_interfaces/Addints_Request, 1>',
        'response': 'sequence<student_interfaces/Addints_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['student_interfaces', 'srv'], 'Addints_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['student_interfaces', 'srv'], 'Addints_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from student_interfaces.srv import Addints_Request
    ...
    def response(self, value):
        if self._check_fields:
            from student_interfaces.srv import Addints_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Addints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'student_interfaces.srv.Addints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from student_interfaces.srv import _addints
...
class Addints(metaclass=Metaclass_Addints):
    from student_interfaces.srv._addints import Addints_Request as Request
    from student_interfaces.srv._addints import Addints_Response as Response
    from student_interfaces.srv._addints import Addints_Event as Event
