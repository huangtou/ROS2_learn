...
#include "student_interfaces/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const student_interfaces::msg::Student & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  student_interfaces::msg::Student & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = student_interfaces::msg::Student;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const student_interfaces::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<student_interfaces::msg::Student *>(
    untyped_ros_message);
...
{
  return &student_interfaces::msg::typesupport_fastrtps_cpp::_Student__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, student_interfaces, msg, Student)() {
  return &student_interfaces::msg::typesupport_fastrtps_cpp::_Student__handle;
}
